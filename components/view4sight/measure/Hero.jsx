          ...
          <div className="section-inner panel">
            ...
            >
              <h1 
                ...
                dangerouslySetInnerHTML={{ __html: t('features_pages.measure.hero.title') }}
              />
              <p 
                className="fs-6 sm:fs-5 text-dark dark:text-white text-opacity-70"
                dangerouslySetInnerHTML={{ __html: t('features_pages.measure.hero.subtitle') }}
              />
            </div>
            <div
            ...
            >
              <div className="panel text-center overflow-hidden rounded-3 border border-5 border-dark dark:border-white dark:border-opacity-20">
                <Image
                  ...
                  src="/assets/images/Measure_hero.jpg"
                  width="1440"
                  height="1024"
                />
              </div>
