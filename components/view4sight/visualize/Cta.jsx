          ...
          <div className="section-inner panel">
            ...
            >
              <h2 className="h3 sm:h1 xl:display-6 m-0">
                Ready to Transform Your <br className="d-none lg:d-block" />
                <span className="text-primary">3D Data Workflow?</span>
              </h2>
              <p className="fs-6 sm:fs-5 text-dark dark:text-white text-opacity-70 mt-1 lg:mt-2">
                Join hundreds of surveyors and engineers already visualizing data effortlessly.
              </p>
