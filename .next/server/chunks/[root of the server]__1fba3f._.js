...
"[project]/app/api/test-polar/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        // Retourner la configuration (sans le token complet)
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: "Configuration loaded",
            config: {
                ...config,
                accessToken: config.accessToken ? "Present (starts with: " + config.accessToken.substring(0, 4) + "...)" : "Missing"
            }
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__1fba3f._.js.map